...
import sys
print("[DEBUG] leaderboard_evaluator.py: start")
import carla
print("[DEBUG] leaderboard_evaluator.py: carla imported")
...
class LeaderboardEvaluator(object):
    ...
    def __init__(self, args, statistics_manager):
        ...
        self.max_scenarios = args.maxScenarios
    ...
    def run(self, args):
        ...
        scenario_count = 0
        while route_indexer.peek() and (self.max_scenarios is None or scenario_count < self.max_scenarios):
            # setup
...
def main():
    ...
    parser.add_argument('--scenarios',
                        ...
                        required=True)
    parser.add_argument('--maxScenarios',
                        type=int,
                        default=20,
                        help='Maximum number of Scenarios mixed with a Route.',
                        required=False)
